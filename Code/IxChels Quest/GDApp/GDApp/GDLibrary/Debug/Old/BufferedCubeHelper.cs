...
{
    //Vertex buffer
    public class BufferedCubeHelper : DrawableGameComponent
    {
        ...
        public BufferedCubeHelper(Main game,
        ...
        private void DrawVertices()
        {
            ...
            //use the data from the buffer reserved, and set, earlier in Initialise()
            this.effect.GraphicsDevice.SetVertexBuffer(this.vertexBuffer);

            //slight change to draw
            this.effect.GraphicsDevice.DrawPrimitives(PrimitiveType.LineList, 0, 12);
        }
